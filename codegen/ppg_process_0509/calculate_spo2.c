...
float calculate_spo2(float inputR)
{
  ...
  return fmaxf(
      fminf(((float)(inputR <= 0.840888038) *
                 (-32.4272461F * inputR + 111.68103F) +
             (float)((inputR > 0.840888038) && (inputR <= 1.02842164)) *
                 (-27.9515381F * (inputR - 0.840888F) + 84.4133453F)) +
                (float)(inputR > 1.02842164) *
                    (-38.5430794F * (inputR - 1.02842164F) + 79.1714935F),
            100.0F),
      65.0F);
}
